...
│   ├── pact/
│   │   ├── modules/               ← ACTIVE .pact source files (dao.pact, dao-types.pact, dao-gas-station.pact)
...
|-----------|-----------------|--------------|
| Pact smart contract (`.pact`) | `pact-examples/pact/modules/` | root, pact-examples/, anywhere else |
| Pact REPL test (`.repl`) | `pact-examples/pact/tests/` | pact-examples/ root, anywhere else |
